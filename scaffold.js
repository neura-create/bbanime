...
function buildIndexHtml() {
  return [
    ...
    '      </ul>',
    '      <span class="footer-copy">&copy; 2026 BBAnime. Todos los derechos reservados.</span>',
    '    </div>',
    '  </footer>',
    '',
...
function buildStyleCss() {
  return [
    ...
    '  --starlight: #F5F1FF;',
    '  --muted: #E7E0FB;',
    '  --bubble-glow: 123, 58, 237;',
    '  --cyan: #35DCE0;',
    '  --gold: #FFC94D;',
    '  --font-display: "Baloo 2", sans-serif;',
    '  --font-body: "Nunito", sans-serif;',
    '  --font-mono: "Space Mono", monospace;',
    '  --copy-shadow: 0 2px 18px rgba(11,10,31,0.85), 0 10px 44px rgba(11,10,31,0.65);',
    '}',
    '',
    ...
    '  background:',
    '    radial-gradient(60vmax 60vmax at 18% 10%, rgba(255,61,143,0.16), transparent 60%),',
    '    radial-gradient(70vmax 70vmax at 85% 30%, rgba(53,220,224,0.10), transparent 55%),',
    '    linear-gradient(180deg, var(--void) 0%, var(--nebula) 55%, var(--nebula-2) 100%);',
    '}',
    '',
    ...
    '  padding: 1.1rem 5vw; transition: background 0.3s ease, backdrop-filter 0.3s ease;',
    '}',
    '.site-header.scrolled { background: rgba(11, 10, 31, 0.55); backdrop-filter: blur(14px); }',
    ...
    '.phase-copy { position: relative; max-width: 30rem; text-shadow: var(--copy-shadow); z-index: 1; }',
    '.phase-copy::before {',
    '  content: ""; position: absolute; inset: -1.6rem -0.8rem; z-index: -1; border-radius: 50%;',
    '  background: radial-gradient(ellipse at center, rgba(var(--bubble-glow), 0.55) 0%, rgba(var(--bubble-glow), 0.32) 45%, rgba(var(--bubble-glow), 0) 75%);',
    '  filter: blur(22px);',
    '}',
    '.phase-copy-wide { max-width: 60rem; }',
    '@media (min-width: 640px) {',
    '  .phase-copy::before { inset: -2.4rem -3.2rem; filter: blur(30px); }',
    '  .phase-copy-wide::before { inset: -2.4rem -4vw; }',
    '}',
    '.section-label {',
    ...
    '  font-size: clamp(3.2rem, 14vw, 8rem); color: var(--bubble-pink);',
    '}',
    '.hero-logo span { color: var(--starlight); }',
    '.hero-tagline { font-size: clamp(1rem, 2vw, 1.3rem); color: var(--muted); font-weight: 700; }',
    ...
    '  border-radius: 999px; box-shadow: 0 0 0 1px rgba(255,61,143,0.4), 0 12px 30px -10px rgba(255,61,143,0.6);',
