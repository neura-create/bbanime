...
function buildStyleCss() {
  return [
    ...
    '.phase-copy::before {',
    '  content: ""; position: absolute; left: 50%; top: 50%; width: 135%; height: 170%;',
    '  transform: translate(-50%, -50%); z-index: -1; filter: blur(10px); pointer-events: none;',
    '  background: radial-gradient(ellipse at center,',
    '    rgba(var(--bubble-glow), 0.82) 0%,',
    '    rgba(var(--bubble-glow), 0.6) 30%,',
    '    rgba(var(--bubble-glow), 0.28) 60%,',
    '    rgba(var(--bubble-glow), 0) 82%);',
    '}',
