...
function buildStyleCss() {
  return [
    ...
    '  background: radial-gradient(ellipse at center, rgba(var(--bubble-glow), 0.75) 0%, rgba(var(--bubble-glow), 0.48) 45%, rgba(var(--bubble-glow), 0) 75%);',
    '  filter: blur(20px);',
    '}',
    '.phase-copy-wide { max-width: 60rem; }',
    '@media (min-width: 640px) {',
    '  .phase-copy::before { inset: -2.4rem -3.2rem; filter: blur(26px); }',
